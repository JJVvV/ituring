...
class BookHomeDataEntity {
  ...
  factory BookHomeDataEntity.fromJson(Map<String, dynamic> json) =>
      $BookHomeDataEntityFromJson(json);
...
class BookHomeDataBlockContents {
  ...
  factory BookHomeDataBlockContents.fromJson(Map<String, dynamic> json) =>
      $BookHomeDataBlockContentsFromJson(json);
...
class BookHomeDataBlockContentsTag {
  ...
  factory BookHomeDataBlockContentsTag.fromJson(Map<String, dynamic> json) =>
      $BookHomeDataBlockContentsTagFromJson(json);
...
class BookHomeDataBlockContentsTagBookItems {
  ...
  String? xAbstract;
  List<BookHomeDataBlockContentsTagBookItemsBookEditionPrices>?
      bookEditionPrices;

  BookHomeDataBlockContentsTagBookItems();

  factory BookHomeDataBlockContentsTagBookItems.fromJson(
          Map<String, dynamic> json) =>
      $BookHomeDataBlockContentsTagBookItemsFromJson(json);

  Map<String, dynamic> toJson() =>
      $BookHomeDataBlockContentsTagBookItemsToJson(this);
...
class BookHomeDataBlockContentsTagBookItemsBookEditionPrices {
  ...
  factory BookHomeDataBlockContentsTagBookItemsBookEditionPrices.fromJson(
          Map<String, dynamic> json) =>
      $BookHomeDataBlockContentsTagBookItemsBookEditionPricesFromJson(json);

  Map<String, dynamic> toJson() =>
      $BookHomeDataBlockContentsTagBookItemsBookEditionPricesToJson(this);
...
class BookHomeDataBlockContentsEditableArea {
  ...
  factory BookHomeDataBlockContentsEditableArea.fromJson(
          Map<String, dynamic> json) =>
      $BookHomeDataBlockContentsEditableAreaFromJson(json);

  Map<String, dynamic> toJson() =>
      $BookHomeDataBlockContentsEditableAreaToJson(this);
...
class BookHomeDataOnPublishBooks {
  ...
  factory BookHomeDataOnPublishBooks.fromJson(Map<String, dynamic> json) =>
      $BookHomeDataOnPublishBooksFromJson(json);
...
class BookHomeDataOnPublishBooksBookEditionPrices {
  ...
  factory BookHomeDataOnPublishBooksBookEditionPrices.fromJson(
          Map<String, dynamic> json) =>
      $BookHomeDataOnPublishBooksBookEditionPricesFromJson(json);

  Map<String, dynamic> toJson() =>
      $BookHomeDataOnPublishBooksBookEditionPricesToJson(this);
